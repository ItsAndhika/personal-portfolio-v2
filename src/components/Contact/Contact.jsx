  ...
  return (
    <section id="contact" className='pt-36'>
        ...
        <div className="container mt-10 px-10 sm:px-5 xl:px-16">
            <form action="" name='contact-form' method='post' className='flex flex-col'>
                ...
                <button type="submit" id='send' className='w-max mx-auto mt-5 px-5 py-2 bg-primary text-slate-900 rounded-full shadow-gold-glow animate-shadow-pulse transition duration-300 ease-in-out hover:bg-secondary lg:px-6 lg:py-4' data-aos="fade-up"  data-aos-easing='ease-in-out' data-aos-once='true' data-aos-duration='1000' onClick={() => {
