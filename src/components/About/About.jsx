    ...
    <section id="about" className='pt-36'>
        ...
        <div className="container flex flex-col items-center px-10 sm:px-5 xl:px-16">
            <article className='flex flex-col justify-center items-center mx-auto pt-10 md:flex-row'>
                <img src="/assets/images/profile.webp" alt="Profile" loading='lazy' className='rounded-2xl w-full shadow-gold-glow animate-shadow-pulse sm:w-96 md:w-1/3' data-aos="fade-up" data-aos-easing='ease-in-out' data-aos-once='true' data-aos-duration='1000'/>
