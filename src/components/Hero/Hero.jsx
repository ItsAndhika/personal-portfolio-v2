            ...
            <article className='w-full md:w-2/3'>
                ...
                <Typewriter
                    options={{
                        ...
                        autoStart: true,
                        delay: 20,
                        wrapperClassName: 'mt-5 text-lg text-primary lg:text-xl 2xl:text-2xl',
                        deleteSpeed: 0,
                        loop: true
                    }}
                />
                <p className='mt-3 mb-5 max-w-lg text-base lg:text-xl lg:mb-10 2xl:text-2xl'>A 15 year old Junior Web Developer who wants to be a better person everyday by learn anything that I like.</p>
